...
├── spec/integration/           # Real Couchbase KV and Query integration specs
├── examples/                   # Cluster probe, KV, and Query examples
...
- `couchbase://user:pass@host[:port]/bucket?params` - KV bucket or Query default bucket plus credentials/options
